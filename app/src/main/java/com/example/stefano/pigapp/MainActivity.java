...
public class MainActivity extends AppCompatActivity implements Observer {
    ...
    private void runOverlay_ContinueMethod(){
        ...
        ChainTourGuide tourGuide2 = ChainTourGuide.init(this)
                .setToolTip(new ToolTip()
                                .setTitle("Menu")
                                .setDescription("Nel menu sono presenti 3 icone: \"Condividi le tue idee\", \"Aggiorna\" e \"Gestione notifiche\".")
                                .setGravity(Gravity.BOTTOM)
                )
                .setOverlay(new Overlay()
                                .setEnterAnimation(mEnterAnimation)
    ...
    private void runOverlayListener_ContinueMethod(){
        ...
        ChainTourGuide tourGuide7 = ChainTourGuide.init(this)
                .setToolTip(new ToolTip()
                                .setTitle("Fine")
                                .setDescription("Il tutorial è finito. Cliccare un punto qualsiasi dello schermo per iniziare ad utilizzare l'app.")
                                .setGravity(Gravity.BOTTOM)
                )
                .setOverlay(new Overlay()
                                .setHoleRadius(0)
